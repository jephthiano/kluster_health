...
$page_url = file_location('home_url','account/account_security/');
			...
			<div class="j-main-body">
				<div class=''style="width:100%;">
					<span class='j-hide-large j-hide-xlarge'>
						<?php
						$header="Account & Security";$back="back"; get_header($header,$back,$menu='','','','j-color1');
						?>
					</span>
					<div class="j-row">
						<div class="j-col l8 j-color6">
							...
							<div class=''>
								<div class='j-padding j-card j-border j-border-color5 j-round j-margin'>
                                    <a href="<?= file_location('home_url','account/email/');?>">
                                    <div style="display:inline-block;width:35px;position:relative;top:10px;"><i class="j-text-color1 j-xlarge <?=icon('envelope');?>"></i></div>
                                ...
                                <div class='j-padding j-card j-border j-border-color5 j-round j-margin'>
                                    <a href="<?= file_location('home_url','account/mobile_number/');?>">
                                    <div style="display:inline-block;width:35px;position:relative;top:10px;"><i class="j-text-color1 j-xlarge <?=icon('mobile');?>"></i></div>
                                    <div style="display:inline;line-height:15px;">
                                ...
                                <div class='j-padding j-card j-border j-border-color5 j-round j-margin'>
                                    <a href="<?= file_location('home_url','account/password/');?>">
                                    <div style="display:inline-block;width:35px;position:relative;top:10px;"><i class="j-text-color1 j-xlarge <?=icon('lock');?>"></i></div>
                                    <div style="display:inline;line-height:15px;">
                                ...
                                <div class='j-padding j-card j-border j-border-color5 j-round j-margin'>
                                    <a href="<?= file_location('home_url','account/notification/');?>">
                                    <div style="display:inline-block;width:35px;position:relative;top:10px;"><i class="j-text-color1 j-xlarge <?=icon('bell');?>"></i></div>
                                    <div style="display:inline;line-height:15px;">
                                        <span class='j-bolder j-text-color7'>Notification</span>
                                        <div class='j-small'style='margin-left:40px;'>Choose your notificattion settings.</div>
                                    </div>
                                    </a>
                                </div>
                                <div class='j-padding j-card j-border j-border-color5 j-round j-margin j-clickable'>
                                    <a href="<?= file_location('home_url','account/delete_account/');?>">
                                    <div class='j-center'>
